 ...
 * PORKCHOP -> UTHERIUM_NUGGET
 * LAMBCHOP -> FORGOTTEN_NUGGET
 *
 * IRON_INGOT -> CLOGGRUM_INGOT
 * GOLD_INGOT -> FROSTEEL_INGOT
 * COOKED_PORKCHOP -> UTHERIUM_INGOT
 * COOKED_LAMBCHOP -> FORGOTTEN_INGOT
 *
...
public class ModLootTablesProvider extends LootTableProvider {
    ...
    public static class Chests implements LootTableSubProvider {
        ...
        private void generateRare(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
            consumer.accept(new ResourceLocation(Treasure.MODID, "injects/chests/rare/undergarden_general"), LootTable.lootTable()
        ...
        private void generateScarce(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
            consumer.accept(new ResourceLocation(Treasure.MODID, "injects/chests/scarce/undergarden_general"), LootTable.lootTable()
